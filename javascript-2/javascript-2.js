...
const orderTotal =  blueProducts.reduce(function(element, index, array, acc){
  return acc += price
}, 0)
...
userInfo.commenterId = 'Thanks for the info'
